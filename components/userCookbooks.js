            ...
            <div className='ml-30 mr-30'>
              <div>
                ...
                <div className='cookbookTitleContainer'>
                  <div className='cookbookTitle min-w-[10em] max-w-[10em] lg:p-4 md:p-4 p-2 rounded-r-lg relative top-[-1em] text-white font-semibold lg:text-2xl md:text-2xl text-lg bg-green-500'>
                    {cookbook.title}
                  </div>
                </div>
              </div>
